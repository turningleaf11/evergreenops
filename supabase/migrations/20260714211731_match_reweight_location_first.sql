-- Re-weight so location dominates (city/county/state are the reliable, always-filled
-- fields); exit strategy is soft (it changes). New: city+4, county+3, state+2,
-- price+2, exit+1, type+1, A-tier+1.
