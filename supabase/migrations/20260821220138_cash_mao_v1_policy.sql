...
begin
  ...
  insert into public.buy_box_criteria (
    workspace_id, asset_class, field, operator, value, hardness, label, active, notes, rule_type
  ) values (
    _workspace_id, 'fix_flip', 'max_offer_rule', 'formula',
    '{"rule":"0.65 * ARV - repairs"}'::jsonb, 'hard',
    'Standard MAO: 65% ARV less repairs', true,
  ...
  insert into public.buy_box_criteria (
    ...
    _workspace_id, 'fix_flip', 'stretch_offer_rule', 'formula',
    '{"rule":"0.68 * ARV - repairs"}'::jsonb, 'soft',
    'Stretch ceiling: 68% ARV less repairs', true,
