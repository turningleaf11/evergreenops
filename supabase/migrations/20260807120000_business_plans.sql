...
-- Matches the permissive "authenticated all" pattern used on every other core
-- content table in this app (goals/cadences/documents/projects/tasks) — real
-- access control happens client-side via visibility/shared_with, same as documents.
