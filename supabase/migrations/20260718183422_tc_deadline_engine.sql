...
-- Assignment tracking needed for the buyer-EMD clock.
...
-- Business holidays (title companies closed). Seeded with US federal observed
-- dates; extend as needed.
...
-- Dedup: one ping per (deal, deadline, due date, bucket).
...
-- The daily scan: emit an event when a deadline is within 3 days or overdue.
