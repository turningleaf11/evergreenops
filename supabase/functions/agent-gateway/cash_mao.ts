...
export async function runAndPersistCashMao(
  ...
  const progress = {
    ...
    status: 'succeeded',
    step_id: step.id,
    maximum_allowable_offer: mao.maximum_allowable_offer,
    supported_offer_range: mao.supported_offer_range,
    pricing_rule_id: mao.pricing_rule.criterion_id,
    pricing_formula: mao.pricing_rule.formula,
