...
const defaultState: StrategyFlowState = {
  strategyItems: [
    {
      id: "si1",
      type: "objective",
      title: "Close 5 wholesale deals per month by end of Q2",
      description: "Focus the wholesale acquisitions team on high-probability deals. Deprioritize speculative leads and concentrate on properties with motivated sellers, clear title, and strong ARV-to-purchase spreads.",
      createdBy: "m1",
      assignedDepartments: ["wholesale", "dispositions"],
      status: "new",
    ...
    },
    {
      id: "si2",
      type: "constraint",
      title: "Hard money lender cap at $2M total exposure",
      description: "Our primary lender will not extend beyond $2M in simultaneous draws. All teams must coordinate closing timelines to avoid exceeding this limit. Prioritize deals that close fastest.",
      createdBy: "m1",
      assignedDepartments: ["wholesale", "portfolio", "operations"],
      status: "new",
    ...
    },
    {
      ...
      description: "Capital allocation decision: focus available capital on wholesale deals with faster ROI. Resume larger portfolio acquisitions when wholesale revenue stabilizes and cash reserves are rebuilt.",
      createdBy: "m1",
      assignedDepartments: ["portfolio"],
      status: "acknowledged",
      ...
      responses: [
        {
          id: "lr1",
          strategyItemId: "si3",
          departmentId: "portfolio",
          responderId: "m10",
          type: "refine",
          groundTruth: "We have the Maple Ridge 24-unit under LOI at $1.8M — already in late-stage negotiation with seller.",
          analysis: "Pausing all portfolio deals above $2M is fine, but Maple Ridge is at $1.8M and within 30 days of closing. Walking away would cost us the $15K earnest money deposit and damage the broker relationship.",
          recommendation: "Grandfather the Maple Ridge deal but pause new portfolio deal sourcing above $1.5M.",
          expectedImpact: "Preserves the Maple Ridge opportunity ($12K/mo projected NOI) while still redirecting future capital to wholesale.",
  ...
  proposals: [
    {
      id: "up1",
      type: "escalate_constraint",
      departmentId: "wholesale",
      createdBy: "m2",
      title: "Need higher earnest money deposit authority",
      reasoning: "Competitive wholesale market in Fulton County requires $5K-$10K earnest money to lock deals. Current authority limit of $2K is causing us to lose deals to faster-moving competitors.",
      recommendation: "Increase per-deal earnest money authority to $7.5K for acquisitions managers, with CEO approval required above that.",
      status: "pending",
