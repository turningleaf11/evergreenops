...
/**
 * Reuses the existing entity_links / files convention:
 * Files for a deal are stored as rows in `lead_files` only when there's a lead.
 * For deals we use the generic "files" bucket and link via crm_activities (type=file)
 * to keep things consistent with existing infrastructure.
 */
export function DealFilesTab({
  ...
  const removeFile = async (f: DealFileRow) => {
    ...
    <div className="space-y-3">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground mb-2">
          Drop OMs, T12s, rent rolls, inspection reports, contracts here
        </p>
