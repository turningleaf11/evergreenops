...
export function ReplyThread({ entityType, entityId, onCountChange }: ReplyThreadProps) {
              ...
              <div className="flex items-center gap-2">
                ...
                {r.user_id === user?.id && (
                  <button
                    ...
                    className="opacity-0 group-hover/reply:opacity-100 text-muted-foreground/70 hover:text-destructive transition-all"
                  >
      ...
      <div className="space-y-2 bg-primary/[0.04] rounded-xl p-3">
        ...
        {draftAudioUrl && (
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => setDraftAudioUrl(null)} className="text-muted-foreground/70 hover:text-destructive"><Trash2 className="h-3 w-3" /></button>
          </div>
        )}
        <div className="flex gap-2">
          ...
          <div className="flex flex-col gap-1 shrink-0 self-end">
            <GiphyPicker onSelect={(url) => setDraftGif(url)}>
              <Button size="icon" variant="ghost" className="h-7 w-7 text-[10px] font-bold text-muted-foreground/70">
                GIF
              </Button>
            </GiphyPicker>
            {recording ? (
              ...
              <Button size="icon" variant="ghost" onClick={startRecording} className="h-7 w-7 text-muted-foreground/70">
